...
Pedimos, por favor, que deem uma olhada nas **[Diretrizes de Contribuição](https://github.com/carolcodes/youtube-br-desenvolvimento/blob/master/CONTRIBUTING.md)** antes. E desde já, agradecemos a todos os contribuidores. Vocês são demais! ❤️❤️
...
- [Canais Brasileiros para Pessoas Desenvolvedoras](#canais-brasileiros-para-pessoas-desenvolvedoras)
	...
	- [Conteúdos 🔥](#conte%C3%BAdos-%F0%9F%94%A5)
		...
		- [Lógica de Programação](#l%C3%B3gica-de-programa%C3%A7%C3%A3o)
...
- [Bonieky Lacerda](https://www.youtube.com/user/bonieky) - Canal do dev sênior Bonieky Lacerda, autor do curso PHP do Zero ao Profissional, com várias dicas sobre carreira em TI. _Tags: `carreira em ti`, `soft skills`_
...
- [One Day Code](https://www.youtube.com/channel/UCAdjZWj-R4Mq8N2GDr6C-0A) - Canal de desenvolvimento e criação de jogos com playlists de cursos, vídeos sobre dicas de carreira, de faculdades de TI e empreendedorismo. _Tags: `construct`, `desenvolvimento de jogos`, `carreira em ti`, `c`, `c++`_
